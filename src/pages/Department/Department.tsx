...
import type { Department, Member } from "../../types/models";
import { MOCK_DEPARTMENTS } from "../../mocks/departments";
import { MOCK_MEMBERS } from "../../mocks/users";
...
const DepartmentManagerPage = () => {
  ...
  const displayMembers =
    currentDept?.level === 3
      ? MOCK_MEMBERS.filter((m) => m.departmentId === currentDept.id)
      : [];
